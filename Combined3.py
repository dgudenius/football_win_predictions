...
HFA = 7.19               # home field advantage as percentage, default is 5.5 (~7.4 seems good)
HFA2 = 7.19              # home field advantage for win chart
HFAE = 65.0              # elo hfa
HFA_P_M = 1.4            # multiplier for home field advantage in playoffs
...
expect_points = 44.8     # Expected total points for calculating point differential (45.7 is ~league average points/game)
percent_mine = 25.3      # % using Pwin instead of Elo (must be float) (~25 seems good)
percent_win_chart = 3.06 # % using expected win chart (must be float) (~3 seems good)
b_factor = 0.91          # Exponential factor to compare Win Chart values Head to Head (0.9 seems good)
K = 20.7
REVERT = 1/2.97
y_factor  = 1.9          # Multiplier for points expectations (try 1.9?)
x_factor  = 1.4          # Root for points expectations (try 1.4?), this and the y_factor are used in compressing/expanding score predictions
